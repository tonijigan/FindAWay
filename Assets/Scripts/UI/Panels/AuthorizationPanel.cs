...
namespace UI.Panels
{
    public class AuthorizationPanel : Panel
    {
        ...
        private void Awake()
        {
            ...
            _autorizationText.text = _localisation.ChangeLanguage(HashedStrings.AuthorizationTextTr,
                HashedStrings.AuthorizationTextRu, HashedStrings.AuthorizationTextEn);
        }
    }
}